    ...
    <v-container fluid="">
        ...
        <v-row class="mx-0 mb-10">
                                ...
                                <tr v-for="(item, index) in cart">
                                    ...
                                    <td class="">
                                        <div>
                                            <v-list>
                                                ...
                                                <v-list-item class="cart__infor__weight">{{ item.weight
                                                }}g</v-list-item>
                                    ...
                                    <td class="text-center">
                                        <v-text-field v-model="item.quantity" type="number" style="width: 100px;"
                                            @update:model-value="updateQuantity(item.id, item.quantity, index)" min="1"
                                            max="10" :rules="quantityValidation"></v-text-field>
                                    </td>
            ...
            <v-col cols="12" md="4">
                ...
                <v-list>
                    <v-list-item class="cart__infor__product">Khổi lượng ước tính : {{ total_weight || 0
                    }}g</v-list-item>
                    <v-list-item class="cart__infor__product">Tổng sản phẩm : {{ total_quantity || 0
                    }}</v-list-item>
