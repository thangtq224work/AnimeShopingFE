                                    ...
                                    <div v-for="(item, index) in navData.header">
                                        <v-list-item :prepend-icon="item.icon" id="" :to="item.path" class="menu__item">
                                            ...
                                            <v-menu activator="parent" v-if="item.children">
                                                <v-list>
                                                    <v-list-item :title="'teonv'" prepend-icon=""></v-list-item>
                                                    <v-divider thickness="2"></v-divider>
                                                    <v-list-item v-for="it in item.children" :title="it.name"
            ...
            <v-expand-transition>
                <v-col cols="12" class="" v-if="showMenu">
                    <v-list class="d-flex flex-wrap flex-md-row flex-column" bg-color="">
                        <v-list-item v-for="(item, index) in navData.content" id="menu-account" :to="item.path">
                            <v-list-item-title>
                                {{ item.name }}
                            </v-list-item-title>
                            <!-- <v-menu activator="parent" v-if="item.children">
